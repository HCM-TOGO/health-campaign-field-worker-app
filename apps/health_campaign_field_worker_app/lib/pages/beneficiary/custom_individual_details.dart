...
//                             isHeadOfHousehold,
//                           ) async {
//                             print("It is in create mode, which is right!");
//                             print("Printing addressModel: $addressModel");
//                             print("Printing individualModel: $individualModel");
...
//                             print("The individual model is: $individual");
//                             final boundary =
//                                 RegistrationDeliverySingleton().boundary;
//                             print("The current bloc state is: ${bloc.state}");
...
//                               BlocBuilder<BeneficiaryRegistrationBloc, BeneficiaryRegistrationState>(
//                                 builder: (context, state) {
...
//                               print('individual type: ${individual}');
...
//                               }
//                             };
//                             print("After this create method: ${bloc.state.householdModel}");
...
class CustomIndividualDetailsPage extends LocalizedStatefulWidget {
  ...
  @override
  State<CustomIndividualDetailsPage> createState() => CustomIndividualDetailsPageState();
}

class CustomIndividualDetailsPageState extends LocalizedState<CustomIndividualDetailsPage> {
  static const _individualNameKey = 'individualName';
