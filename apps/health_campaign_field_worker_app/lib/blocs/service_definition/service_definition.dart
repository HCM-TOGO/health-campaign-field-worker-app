...
import '../../models/entities/assessment_checklist/service_definition.dart' as assessment_local;
...
class ServiceDefinitionBloc
  ...
  FutureOr<void> _handleFetch(
    ...
    final results = await serviceDefinitionDataRepository.search(
      assessment_local.ServiceDefinitionSearchModel(
        tenantId: DigitDataModelSingleton().tenantId,
      ) as ServiceDefinitionSearchModel,
    );
