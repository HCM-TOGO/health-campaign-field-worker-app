...
class CustomDigitChip extends StatefulWidget {
  final String label;
  ...
  @override
  _CustomDigitChipState createState() => _CustomDigitChipState();
}

class _CustomDigitChipState extends State<CustomDigitChip> {
